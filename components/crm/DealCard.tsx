...
export default function DealCard({ deal, onMove, onEmail, onSMS, onSchedule }: DealCardProps) {
  ...
  return (
    <div className="p-3 rounded-lg border border-border bg-gradient-to-br from-indigo-500/10 via-purple-500/10 to-pink-500/10 hover:from-indigo-500/20 hover:via-purple-500/20 hover:to-pink-500/20 transition-colors cursor-pointer" onClick={() => router.push(`/crm/deals/${deal.id}`)}>
